...
class SetNameViewController: UIViewController {
    ...
    @IBAction func continueToSetProfileInfo(_ sender: UIButton) {
        ...
        SwapUser(username: getUsernameOfSignedInUser()).set(Firstname: firstnameField.text,  Lastname: lastnameField.text, Phonenumber: getSavedPhonenumber(), Email: getSavedEmail(), isPrivate: true, Points: 0, Swapped: 0, Swaps: 0, ProfileImage: defaultImage, QRImage: swapCodeImage,
